...
*/
    ...
    override fun visit(node: ASTNode<out Token>, value: CalculatorData): CalculatorData {
        return when(node.getToken()) {
            ...
            CalculatorGrammarInfo.FACT -> visit_FACT(node as ASTNode.TerminalNode<CalculatorGrammarInfo.FACT>, value)
            ...
            CalculatorGrammarInfo.primitive -> visit_primitive(node as ASTNode.InnerNode<CalculatorGrammarInfo.primitive>, value)
            CalculatorGrammarInfo.atom -> visit_atom(node as ASTNode.InnerNode<CalculatorGrammarInfo.atom>, value)
            CalculatorGrammarInfo.factorial -> visit_factorial(node as ASTNode.InnerNode<CalculatorGrammarInfo.factorial>, value)
    ...
    fun visit_FACT(node: ASTNode.TerminalNode<CalculatorGrammarInfo.FACT>, value: CalculatorData): CalculatorData {
        return visitTerminal(node.getToken()).also { it.text = node.getToken().getText() }
    }
    ...
    */
    fun visit_factor_1(node: ASTNode.InnerNode<CalculatorGrammarInfo.factor>, value: CalculatorData): CalculatorData {
        val children = mutableListOf<CalculatorData>()
        children.add(visit_primitive(node.getChild(0), CalculatorData()))
    ...
    primitive -> atom factorial
    */
    fun visit_primitive(node: ASTNode.InnerNode<CalculatorGrammarInfo.primitive>, value: CalculatorData): CalculatorData {
        val children = mutableListOf<CalculatorData>()
        children.add(visit_atom(node.getChild(0), CalculatorData()))
        children.add(visit_factorial(node.getChild(1), CalculatorData()))
        value.value = CalculatorData.Macro.factorial(children[0].value, children[1].value)
        return value
    }
    ...
    */
    ...
    fun visit_factorial(node: ASTNode.InnerNode<CalculatorGrammarInfo.factorial>, value: CalculatorData): CalculatorData {
        return when (val id = node.getExpansion().getId()) {
            0 -> visit_factorial_0(node, value)
            1 -> visit_factorial_1(node, value)
    ...
    */
    fun visit_factorial_0(node: ASTNode.InnerNode<CalculatorGrammarInfo.factorial>, value: CalculatorData): CalculatorData {
        val children = mutableListOf<CalculatorData>()
        children.add(visit_FACT(node.getChild(0), CalculatorData()))
        children.add(visit_factorial(node.getChild(1), CalculatorData()))
        value.value = children[1].value + 1
        return value
    }
    ...
    factorial -> <eps>
    */
    fun visit_factorial_1(node: ASTNode.InnerNode<CalculatorGrammarInfo.factorial>, value: CalculatorData): CalculatorData {
        val children = mutableListOf<CalculatorData>()
