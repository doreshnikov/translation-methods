...
object PrefixAttributedVisitorInfo : VisitorInfo {
    ...
    */
    fun visit_${token}(node: ${getNodeType(token)}): PrefixAttributedVisitorInfoData"""
        } else {
            """
    fun visit_${token}(node: ${getNodeType(token)}): PrefixAttributedVisitorInfoData {
...
${expansions.joinToString("\n") {
    ...
    $token -> $it
    */
    fun visit_${token}_${it.getId()}(node: ${getNodeType(token)}): PrefixAttributedVisitorInfoData"""
            }}"""
        }
    }
    ...
    override fun getAll(): String {
        return Beautifier.detabify(
            """/**
This code is generated by [${PrefixAttributedVisitorInfo::class.qualifiedName}] derived from [${VisitorInfo::class.qualifiedName}]
...
interface $className : ${Visitor::class.simpleName}<PrefixAttributedVisitorInfoData> {
