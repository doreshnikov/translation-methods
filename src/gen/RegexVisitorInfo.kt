...
fun main() {
    File("C:\\Users\\jetbrains\\IdeaProjects\\translation-methods\\src\\gen\\RegexVisitorInfoGenerated.kt").bufferedWriter().use { out ->
...
object RegexVisitorInfo : VisitorInfo {
    ...
    private val grammarInfo = RegexGrammarInfo
    private val packageName = "gen"
    private val className = "RegexVisitorInfoGenerated"
