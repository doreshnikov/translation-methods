...
object RegexAttributedVisitorInfo : VisitorInfo {
    ...
    */
    fun visit_${token}(node: ${getNodeType(token)}): RegexAttributedVisitorInfoData"""
        } else {
            """
    fun visit_${token}(node: ${getNodeType(token)}): RegexAttributedVisitorInfoData {
...
${expansions.joinToString("\n") {
    ...
    $token -> $it
    */
    fun visit_${token}_${it.getId()}(node: ${getNodeType(token)}): RegexAttributedVisitorInfoData"""
            }}"""
        }
    }
    ...
    override fun getAll(): String {
        return Beautifier.detabify(
            """/**
This code is generated by [${RegexAttributedVisitorInfo::class.qualifiedName}] derived from [${VisitorInfo::class.qualifiedName}]
...
interface $className : ${Visitor::class.simpleName}<RegexAttributedVisitorInfoData> {
