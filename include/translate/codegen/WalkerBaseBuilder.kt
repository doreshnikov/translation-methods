...
class WalkerBaseBuilder(
    private val packageName: String,
    private val grammarInfoObject: GrammarInfo
) : BuilderHelper {

    private val interfaceName = "${grammarInfoObject.getSimpleName()}${Beautifier.className(Walker::class)}Base"
...
${getDefinedTokens().joinToString("\n") { "\t\t\t${getFullName(it)} -> visit_${it}(node as ${getNodeType(it)})" }}
    ...
    override fun getAll(): String {
        ...
        return Beautifier.detabify(
            """/**
This code is generated by [${WalkerBaseBuilder::class.qualifiedName}] derived from [${BuilderHelper::class.qualifiedName}]
